...
vec3 get_specular(vec3 n, vec3 v, vec3 l_d, float roughness, vec3 F0, out vec3 ks)
{
	vec3 radiance;
	...
	float direct_intensity = .4;
	if(roughness == 0.021)
		direct_intensity = 5.0;
