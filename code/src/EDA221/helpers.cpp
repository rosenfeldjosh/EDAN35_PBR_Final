...
//GLuint
//eda221::createCubemapTexture(uint32_t width, uint32_t height)
//{
//	GLuint g_cubeTexture = 0u;
...
//				width, height, 0, GL_RGBA, GL_UNSIGNED_BYTE, &testData[0]);
//		}
//		else
//		{
//			glTexImage2D(GL_TEXTURE_CUBE_MAP_POSITIVE_X + loop, 0, GL_RGBA8,
//				width, height, 0, GL_RGBA, GL_UNSIGNED_BYTE, &xData[0]);
//		}
//	}
